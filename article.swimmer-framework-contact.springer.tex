...
\titlerunning{\review{A computational framework for swimmers}}
...
Let us define the mass of the $i$-th swimmer by  \review{$\mass^i = \int_{\Solid^i} \Density_{\Solid}^i$, where $\Solid^i = \Solid^i_0$ is the reference configuration}, %, let $\CenterMassi = \frac{1}{\mass^i} \int_{\Solid^i} \Density_{\Solid}^i x$ be its center of mass, 
